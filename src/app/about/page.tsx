    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl space-y-12">
      <div className="text-center space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-black font-heading text-cream-100">
          {lang === "ar" ? "قصة عالم على مزاجك" : "The Story of 3alamzagak"}
        </h1>
      ...
      <div className="p-8 rounded-3xl bg-navy-900 border border-gold-500/20 space-y-6 text-sm text-cream-200 leading-relaxed">
        ...
        <p>
          {lang === "ar"
            ? "تأسس عالم على مزاجك (3alamzagak) من شغف حقيقي بإعادة روح التنافس والضحك والجمعات إلى كل بيت مصري وعربي. نؤمن بأن الألعاب ليست مجرد كروت أو قطع رقعة، بل هي وسيلة لصنع ذكريات لا تُنسى وسهرات مليئة بالتحدي والذكاء."
        ...
        <h2 className="text-xl font-bold text-gold-400 border-b border-gold-500/20 pb-3">
          {lang === "ar"
            ? "جودة ملَكية بدون مساومة"
            : "Royal Quality Standards"}
        </h2>
        <p>
          {lang === "ar"
            ? "من اختيار أنواع الخشب الطبيعي كالجان والجوز لشطرنج وطاولة الزهر، إلى طباعة كروت لعبة سبيدي وحُضبت وكومة الـ 10 بخامات مقاومة للماء والخدش، نحرص في عالم على مزاجك على تقديم أعلى مستويات الفخامة والمتانة."
