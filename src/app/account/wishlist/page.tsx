    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      <div className="border-b border-gold-500/20 pb-4">
        ...
        <p className="text-xs text-gray-400 mt-1">
          {lang === "ar"
            ? "الألعاب المحفوظة لسهراتك القادمة"
            : "Saved games for your upcoming game nights"}
        </p>
      </div>
      ...
      {wishlistedProducts.length === 0 ? (
        <div className="p-16 text-center bg-navy-900 border border-gold-500/20 rounded-3xl space-y-4 max-w-md mx-auto">
          ...
          <h3 className="text-lg font-bold text-cream-100">
            لا توجد ألعاب في المفضلة حالياً
          </h3>
          <p className="text-xs text-gray-400">
            تصفح متجر عالم على مزاجك واحفظ ألعابك المفضلة بالنقر على الأيقونة.
          </p>
          <Link
            href="/shop"
